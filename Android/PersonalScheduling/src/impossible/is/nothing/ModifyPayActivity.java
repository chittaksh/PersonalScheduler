...
public class ModifyPayActivity extends Activity 
{
...
public int pid=0;
	 @Override
	    public void onCreate(Bundle savedInstanceState) {
	        ...
	        setContentView(R.layout.modifypay);
	        ...
	        Bundle extras= getIntent().getExtras(); 
		      ...
		      //  Toast.makeText(ModifyTodoActivity.this, msg,Toast.LENGTH_LONG).show();
		       ...
		       spinner1.setSelection(t);
		        ...
		        et3=(EditText) findViewById(R.id.paytask);
		        et3.setText(info[3]);
		        b1.setOnClickListener(new View.OnClickListener() 
		        {
		            ...
		            {   
		               Bundle extras= getIntent().getExtras(); 
		 		       String msg=String.valueOf(extras.getString("info"));
		 		       String info[]=msg.split("\\|");
		 		       String task=String.valueOf(info[2].trim());
		 		      String uid=String.valueOf(extras.getString("uid")).trim();
		            	 db.open();        
		             	//Cursor id;
		            	 Boolean id;
		            	// String id="";
		             	String dt,time,newtask;
		             //	Bundle extras= getIntent().getExtras(); 
		              //  String uid=String.valueOf(extras.getString("uid")).trim();
		             	...
		             	id=db.updatePayInfo(dt,time,newtask,pid);
		            // 	 if (id.moveToFirst()) 
			          //     {
	             	//	Toast.makeText(ModifyPayActivity.this,id.getCount() ,Toast.LENGTH_LONG).show();
			          //     }
		             	...
		             	if(id==true)
		             	{
		             		Toast.makeText(ModifyPayActivity.this, "Payment Updated Successfully...",Toast.LENGTH_LONG).show();
		             		Intent i=new Intent(ModifyPayActivity.this,PaymentActivity.class);
		             		i.putExtra("uid", uid);
			    			startActivityForResult(i, 0); 
		             	}
		             	else
		             		Toast.makeText(ModifyPayActivity.this, "Updation Failed...",Toast.LENGTH_LONG).show();
		             	db.close();
		            }

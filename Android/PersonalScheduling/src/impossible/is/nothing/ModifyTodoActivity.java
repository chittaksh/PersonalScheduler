...
public class ModifyTodoActivity extends Activity 
{
	 ...
	 @Override
	    public void onCreate(Bundle savedInstanceState) {
	        ...
	        setContentView(R.layout.modifytodo);
		      ...
		      //  Toast.makeText(ModifyTodoActivity.this, msg,Toast.LENGTH_LONG).show();
		        ...
		        b1.setOnClickListener(new View.OnClickListener() 
		        {
		            ...
		            {                
		             	...
		             	id=db.updateTodoInfo(dt, time, task);
		             	et1.setText("");
		             	et2.setText("");
		             	et3.setText("");
		             	et1.requestFocus();
		             	if(id==true)
		             		Toast.makeText(ModifyTodoActivity.this, "Updated Successfully...",Toast.LENGTH_LONG).show();
		             	else
		             		Toast.makeText(ModifyTodoActivity.this, "Updation Failed...",Toast.LENGTH_LONG).show();
		             	db.close();
		            }
		        ...
		        b2.setOnClickListener(new View.OnClickListener() 
		        {
		            public void onClick(View v) 
		            {                
		            	 Intent i=new Intent(ModifyTodoActivity.this,TodoActivity.class);
		                 startActivity(i);
		            }
		        });
	 }
